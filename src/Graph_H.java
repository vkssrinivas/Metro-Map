...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void Create_Metro_Map(Graph_H g)
		{
			g.addVertex("Miyapur~B");
			g.addVertex("KPHB~B");
			g.addVertex("Erragadda~B");
			g.addVertex("Ameerpet~BY");
			g.addVertex("Panjagutta~B");
			g.addVertex("Osmania Medical College~B");
			g.addVertex("MG BS~BO");
			g.addVertex("LB Nagar~B");
			g.addVertex("Raidurg~Y");
			g.addVertex("Madhapur~Y");
			g.addVertex("Yusufguda~Y");
			g.addVertex("Begumpet~Y");
			g.addVertex("Parade Ground~YO");
			g.addVertex("Nagole~Y");
			g.addVertex("Secunderabad West~O");
			g.addVertex("RTC X Roads~O");
			g.addVertex("NarayanGuda~O");
			g.addVertex("Assembly~BP");
			g.addVertex("Stadium~PR");
			g.addVertex("Jubilee Hills~P");
			
			g.addEdge("Miyapur~B", "KPHB~B", 8);
			g.addEdge("KPHB~B", "Erragadda~B", 10);
			g.addEdge("Erragadda~B", "Panjagutta~B", 8);
			g.addEdge("Erragadda~B", "Ameerpet~BY", 6);
			g.addEdge("Ameerpet~BY", "Osmania Medical College~B", 9);
			g.addEdge("Osmania Medical College~B", "MG BS~BO", 7);
			g.addEdge("MG BS~BO", "LB Nagar~B", 6);
			g.addEdge("Raidurg~Y", "Madhapur~Y", 15);
			g.addEdge("Madhapur~Y", "Nagole~Y", 6);
			g.addEdge("Nagole~Y", "Ameerpet~BY", 7);
			g.addEdge("Ameerpet~BY", "Parade Ground~YO", 1);
			g.addEdge("Parade Ground~YO", "Begumpet~Y", 2);
			g.addEdge("Begumpet~Y", "Yusufguda~Y", 5);
			g.addEdge("Parade Ground~YO", "Secunderabad West~O", 2);
			g.addEdge("Secunderabad West~O", "RTC X Roads~O", 7);
			g.addEdge("RTC X Roads~O", "NarayanGuda~O", 8);
			g.addEdge("Osmania Medical College~B", "Assembly~BP", 2);
			g.addEdge("Jubilee Hills~P", "Assembly~BP", 2);
			g.addEdge("Jubilee Hills~P", "Stadium~PR", 3);
		}
